...
- Describe 0.1.4 narrowly as end-to-end encryption for DSH session content between Mobile and Companion; retain the documented metadata and forward-secrecy limits.
